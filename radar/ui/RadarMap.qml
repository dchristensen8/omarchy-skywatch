...
// preventStealing so the map's drag wins over the enclosing weather panel.
import QtQuick
...
Item {
    ...
    MouseArea {
        ...
        // Keep the drag from being stolen by an enclosing scrollable (e.g. the
        // Skywatch weather panel wraps the radar in a Flickable).
