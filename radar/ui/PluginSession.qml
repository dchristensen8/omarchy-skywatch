...
QtObject {
    ...
    readonly property string root: Quickshell.env("OMASTORM_ROOT") || Quickshell.env("HOME") + "/.config/omarchy/plugins/dchristensen8.skywatch/radar"
    ...
    property FileView manifestFile: FileView {
        path: Quickshell.env("HOME") + "/.config/omarchy/plugins/dchristensen8.skywatch/manifest.json"
        watchChanges: true
        printErrors: false
